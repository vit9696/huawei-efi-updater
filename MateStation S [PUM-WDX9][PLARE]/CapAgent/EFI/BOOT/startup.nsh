if exist fs0:\EFI\HUAWEI_PREPARE\CapAgent.efi then
  ...
  bcfg boot add 0 fs0:\EFI\HUAWEI\CapAgent.efi "Huawei Firmware Update Program"
  reset -c
endif
...
if exist fs1:\EFI\HUAWEI_PREPARE\CapAgent.efi then
  ...
  bcfg boot add 0 fs1:\EFI\HUAWEI\CapAgent.efi "Huawei Firmware Update Program"
  reset -c
endif
...
if exist fs2:\EFI\HUAWEI_PREPARE\CapAgent.efi then
  ...
  bcfg boot add 0 fs2:\EFI\HUAWEI\CapAgent.efi "Huawei Firmware Update Program"
  reset -c
endif
...
if exist fs3:\EFI\HUAWEI_PREPARE\CapAgent.efi then
  ...
  bcfg boot add 0 fs3:\EFI\HUAWEI\CapAgent.efi "Huawei Firmware Update Program"
  reset -c
endif
